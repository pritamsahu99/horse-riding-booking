...
const HorsesData = ({ onBookNow }) => {
    const horsesDetails = [
        { keyIndex: 1, 
          ...
          imgurl: './src/assets/spirit-horse-landscpae.jpg' },
        { keyIndex: 2, 
          name: 'Thunder Horse',
        ...
        { keyIndex: 4, 
          ...
          imgurl: './src/assets/shadow-horse-landscape.jpg' },
